...
for i in range(2007,2019):
    print('https://www.soccernews.com/soccer-transfers/english-premier-league-transfers-{}-{}/'.format(i, i + 1))
    # Abrir a página do Python Club
    firefox.get('https://www.soccernews.com/soccer-transfers/english-premier-league-transfers-{}-{}/'.format(i, i+1))
    ...
    df.to_csv(r'/home/matheus/Transferências/transferencias-ING-{}-{}.csv'.format(i, i+1))
    print(i)
# Fechar navegador
firefox.quit()
