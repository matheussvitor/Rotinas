...
for i in range(2007,2019):
    print('https://www.soccernews.com/soccer-transfers/italian-serie-a-transfers-{}-{}/'.format(i, i + 1))
    # Abrir a página do Python Club
    firefox.get('https://www.soccernews.com/soccer-transfers/italian-serie-a-transfers-{}-{}/'.format(i, i+1))
    ...
    dados = {'Data':[], 'Nome':[],'Saída':[], 'Destino':[], 'Preço':[], 'Ano':[], 'Mês':[], 'Dia':[]}
    ...
    df.to_csv(r'/home/matheus/Transferências/transferencias-ITA-{}-{}.csv'.format(i, i+1))
    print(i)
# Fechar navegador
firefox.quit()
